# PESQUISA {{SLUG}} — FASE 0 (state file)
...
>
> Rodar:
> `scripts/cp.sh hapvida-article-builder-v7 checkpoint_fase0.py artigos/{{SLUG}}/PESQUISA_{{SLUG}}_COMPLETO.md {{TIPO}} | tee artigos/{{SLUG}}/checkpoints/fase0.txt`
...
<!-- colar aqui o bloco gerado em PLANO_MODELOS_{{SLUG}}.md -->
