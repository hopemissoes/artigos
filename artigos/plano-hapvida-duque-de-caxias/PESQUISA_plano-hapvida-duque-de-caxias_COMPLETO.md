# PESQUISA plano-hapvida-duque-de-caxias — FASE 0 (state file)
...
>
> Rodar:
> `scripts/cp.sh hapvida-article-builder-v7 checkpoint_fase0.py artigos/plano-hapvida-duque-de-caxias/PESQUISA_plano-hapvida-duque-de-caxias_COMPLETO.md city | tee artigos/plano-hapvida-duque-de-caxias/checkpoints/fase0.txt`
...
<!-- colar aqui o bloco gerado em PLANO_MODELOS_plano-hapvida-duque-de-caxias.md -->
